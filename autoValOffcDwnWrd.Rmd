...
prc.data.L$CVWL <- round(prc.data.L$CVWL, digits = 1)
prc.data.L$CVR <- round(prc.data.L$CVR, digits = 1)
prc.data.H <- calculate_aov_infos( create_table_ep_15(val.prec.L2) )
prc.data.H$CVWL <- round(prc.data.H$CVWL, digits = 1)
prc.data.H$CVR <- round(prc.data.H$CVR, digits = 1)
