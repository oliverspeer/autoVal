...
val.prec <- read_excel("C:/R_local/vdata.xlsx", sheet = "PREC")
...
```{r intra assay table, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r inter assay table, echo = FALSE, message = FALSE, warning = FALSE}
