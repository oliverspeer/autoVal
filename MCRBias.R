...
m1 <- mcreg(x,y,method.reg="PaBa", method.ci="jackknife",
            mref.name="serum.crea",mtest.name="plasma.crea", na.rm=TRUE)
m2 <- mcreg(x,y,method.reg="PaBa", method.ci="bootstrap",
...
plotBias(m2, ci.area=TRUE, ci.border=TRUE)
plotBias(m2, ci.area=TRUE, ci.border=TRUE, prop=TRUE)
plotBias(m2, ci.area=FALSE, ci.border=TRUE, prop=TRUE, cut.point=0.6)
plotBias(m2, ci.area=FALSE, ci.border=TRUE, prop=TRUE, cut.point=0.6,
