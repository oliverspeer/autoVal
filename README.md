...
With DBI, RSQLite, mcr, officedown, RMarkdown and Quarto.
...
For bigger data amounts (validation of 35 assays from DxI) data are transfered to a SQLite database. Automated dashboards in shiny, automated reports in Excel, detailed validation-reports in markdown.
